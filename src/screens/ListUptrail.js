    ...
    return <View style={styles.container}>
      <View style={buttonStyles.buttons}>
        <Button
          ...
          style={[buttonStyles.button, { backgroundColor: pageMap ? colors.lightGray : colors.primary }]}
        >
          List
            </Button>
        <Button
          ...
          style={[buttonStyles.button, { backgroundColor: pageMap ? colors.primary : colors.lightGray }]}
        >
          Map
            </Button>
      </View>
